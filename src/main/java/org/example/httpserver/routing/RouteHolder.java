...
public class RouteHolder {
  private static final ConcurrentHashMap<String, RouteHandler<?>> GET = new ConcurrentHashMap<>();
  private static final ConcurrentHashMap<String, RouteHandler<?>> POST = new ConcurrentHashMap<>();
  ...
  public static void bindPOST(String route, RouteHandler<?> action) {
    POST.put(route, action);
  }
